...
export const supabaseClient = createClient("https://pekbxlntxvraydqebjzw.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBla2J4bG50eHZyYXlkcWVianp3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTEwODAwMzMsImV4cCI6MjAwNjY1NjAzM30.u-CIyn8aiwy2QGRChPOQe2-zlMqZHWrfNqakVRqf3QQ");


serve({ port: 5000 }).then(async (server) => {
...
serve(async (req) => {
  ...
  const prompt = stripIndent`${oneLine`
    You are a representative that is very helpful when it comes to talking about Sathvik Only ever answer
